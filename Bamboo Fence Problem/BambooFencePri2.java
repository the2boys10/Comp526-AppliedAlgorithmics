...
public class BambooFencePri2 {
	...
	public static void main(String[] args) {
		...
		Perque1.add(4);	Perque2.add(6);
		Perque1.add(7);	Perque2.add(0);
		Perque1.add(5);	Perque2.add(2);
		Perque1.add(6);	Perque2.add(7);
		Perque1.add(4);	Perque2.add(3);
		Perque1.add(5);	Perque2.add(7);
		Perque1.add(6);	Perque2.add(0);
		...
		Perque1.add(4);	Perque2.add(6);
		Perque1.add(7);	Perque2.add(0);
		Perque1.add(5);	Perque2.add(0);
		Perque1.add(6);	Perque2.add(7);
		Perque1.add(4);	Perque2.add(3);
		Perque1.add(5);	Perque2.add(7);
		Perque1.add(6);	Perque2.add(0);
		Perque1.add(7);	Perque2.add(2);
		Perque1.add(4);	Perque2.add(5);
		Perque1.add(6);	Perque2.add(7);
		Perque1.add(1);	Perque2.add(3);
		Perque1.add(5);	Perque2.add(7);
		Perque1.add(4);	Perque2.add(6);
		Perque1.add(7);	Perque2.add(0);
		Perque1.add(5);	Perque2.add(2);
